...
window.onload = function () {
	...
	let soul_count = document.getElementById('SoulsCount');
	let life_count = document.getElementById('LifeCount');
	let player_status = document.getElementById('PlayerStatus');
	let power_active = document.getElementById('PowerActive');
	let pause_game = document.getElementById('PauseGame');
	let reload_game = document.getElementById('ReloadGame');
	let close_menu = document.getElementById('CloseMenu');
	let pause_menu = document.getElementById('PauseMenu');
	let menu_overlay = document.querySelector('.menu_overlay');
	let menu_container = document.querySelector('.menu_container');
	let power_up_text = document.getElementById('PowerUpText');
	let main_menu = document.getElementById('MainMenu');
	let count_down = document.getElementById('CountDown');
	let easy_level = document.getElementById('EasyLevel');
	let normal_level = document.getElementById('NormalLevel');
	let hardcore_level = document.getElementById('HardcoreLevel');
	let game_over = document.getElementById('GameOver');
	let restart_game = document.getElementById('RestartGame');
	let reload_window = document.getElementById('ReloadWindow');


	//Create image
	let life_img = document.createElement('img');
	...
	//Create monsters
	let imp = Monster({});
	let revenant = Monster({});
	let baron = Monster({});
	let knight = Monster({});
	let cyberdemon = Monster({});
	let cacodemon = Monster({});
	let mancubus = Monster({});
	let spider = Monster({});
	let boss = Monster({});
	let m_empty = Monster({});

	//Empty container for monsters
	let monster, monster2, danger_level;
