...
var _html2canvas = __webpack_require__(121);
...
//Constants
var BACK_URL = !game.production ? 'http://localhost:3000' : 'http://game.api.dakio.co';
...
function renderError(string) {
	if ((typeof string === 'undefined' ? 'undefined' : _typeof(string)) === Array) {
		string = string[0];
	}
