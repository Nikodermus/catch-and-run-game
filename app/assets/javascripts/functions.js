...
function createCanvas() {
	var s_menu = pause_menu.style.visibility;
	var s_countdown = count_down.style.visibility;
	var s_game_over = game_over.style.visibility;
...
var user_game, difficulty_game;

function getDifficultyGame() {
