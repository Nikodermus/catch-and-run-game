...
// Hero image
hero.image.src = "/assets/img/" + hero.name + ".png";
...
// Catchable image
catchable.image.src = "/assets/img/lost_soul.png";
...
imp.image.src = "/assets/img/imp.png";
imp.sound = new Howl({
...
revenant.image.src = "/assets/img/revenant.png";
...
baron.image.src = "/assets/img/baron.png";
...
knight.image.src = "/assets/img/knight.png";
...
cyberdemon.image.src = "/assets/img/cyberdemon.png";
...
cacodemon.image.src = "/assets/img/cacodemon.png";
...
mancubus.image.src = "/assets/img/mancubus.png";
...
spider.image.src = "/assets/img/spider.png";
...
boss.image.src = "/assets/img/final_boss.png";
boss.sound = new Howl({
...
function loadGame(modifier) {
    ...
    for (i of drawables) {
        images_url.push("/assets/img/" + i.name + ".png");
        for (var j = 1; j < 9; j++) {
            images_url.push("/assets/img/" + i.name + "_" + j + ".png");
        }
    }
    ...
    if (game.playable) {
        ...
        elems.forEach(function (elem, i) {
            if (elem.y_pos && elem.x_pos) {
                elem.image.src = "/assets/img/" + elem.name + "_2.png";
            } else if (elem.x_pos && elem.y_neg) {
                elem.image.src = "/assets/img/" + elem.name + "_4.png";
            } else if (elem.x_neg && elem.y_neg) {
                elem.image.src = "/assets/img/" + elem.name + "_6.png";
            } else if (elem.x_neg && elem.y_pos) {
                elem.image.src = "/assets/img/" + elem.name + "_8.png";
            } else if (elem.y_pos && !elem.x_pos && !elem.x_neg) {
                elem.image.src = "/assets/img/" + elem.name + "_1.png";
            } else if (elem.x_pos && !elem.y_pos && !elem.y_neg && !elem.x_neg) {
                elem.image.src = "/assets/img/" + elem.name + "_3.png";
            } else if (elem.x_neg && !elem.y_pos && !elem.y_neg && !elem.x_pos) {
                elem.image.src = "/assets/img/" + elem.name + "_7.png";
            } else if (elem.y_neg && !elem.x_pos && !elem.x_neg && !elem.y_pos) {
                elem.image.src = "/assets/img/" + elem.name + "_5.png";
            } else if (!elem.y_pos && !elem.y_neg && !elem.x_pos && !elem.x_neg) {
                elem.image.src = "/assets/img/" + elem.name + ".png";
            }
        });
        ...
        if (hero.y_pos && hero.x_pos) {
            hero.image.src = "/assets/img/" + hero.name + "_2.png";
        } else if (hero.x_pos && hero.y_neg) {
            hero.image.src = "/assets/img/" + hero.name + "_4.png";
        } else if (hero.x_neg && hero.y_neg) {
            hero.image.src = "/assets/img/" + hero.name + "_6.png";
        } else if (hero.x_neg && hero.y_pos) {
            hero.image.src = "/assets/img/" + hero.name + "_8.png";
        } else if (hero.y_pos && !hero.x_pos && !hero.x_neg) {
            hero.image.src = "/assets/img/" + hero.name + "_1.png";
        } else if (hero.x_pos && !hero.y_pos && !hero.y_neg && !hero.x_neg) {
            hero.image.src = "/assets/img/" + hero.name + "_3.png";
        } else if (hero.x_neg && !hero.y_pos && !hero.y_neg && !hero.x_pos) {
            hero.image.src = "/assets/img/" + hero.name + "_7.png";
        } else if (hero.y_neg && !hero.x_pos && !hero.x_neg && !hero.y_pos) {
            hero.image.src = "/assets/img/" + hero.name + "_5.png";
        ...
        if (
            ...
            if (hero.killable) {
                ...
                game.lifes--;
                if (game.lifes >= 3) {
                    player_status.src = `/assets/img/3_lifes.gif`;
                } else if (game.lifes > 0) {
                    player_status.src = `/assets/img/${game.lifes}_lifes.gif`;
                }
                gameOver();
            } else {
                monster = m_empty;
        ...
        if (
            ...
            if (power_active.name !== 'lifes' && power_active.name !== 'red' && power_active.name !== 'empty') {
                power_active.src = "/assets/img/" + power_up.name + ".png";
            }
            catchable.sound.play();
...
function render() {
    ...
    //Draw Power Up
    power_up.image.src = "/assets/img/" + power_up.name + ".png";
